...
SolveResult finish(const std::string& name, const FlowShopInstance& instance, const SolveConfig& config,
    ...
    Result result{instance.id, name, best.objective, elapsed_since(started), instance.instance_seed,
                  config.solve_seed, config.round, true, best_sequence};
...
SolveResult greedy_random_search(const FlowShopInstance& instance, const SolveConfig& config, const std::string& name) {
    instance.validate();
