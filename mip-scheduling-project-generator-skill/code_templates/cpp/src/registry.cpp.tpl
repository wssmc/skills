...
const std::map<std::string, SolverFunction> &algorithm_registry() {
    static const std::map<std::string, SolverFunction> registry{
        {"random_search", solve_random_search}, {"sa_basic", solve_sa_basic},
        {"ma_basic", solve_ma_basic},           {"ig_basic", solve_ig_basic},
        {"ga_basic", solve_ga_basic},           {"ts_basic", solve_ts_basic},
    };
    return registry;
}
